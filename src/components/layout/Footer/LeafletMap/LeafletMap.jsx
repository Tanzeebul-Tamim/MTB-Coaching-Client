...
const LeafletMap = ({ smallDevice }) => {
    ...
    return (
        ...
        >
            <div className="absolute z-[9999] transition-all duration-300 lg:opacity-0 lg:group-hover:opacity-100 right-0 lg:top-2 -top-2 lg:hover:scale-105 lg:hover:right-1 lg:hover:top-2 ease-in-out">
                <a
