                ...
                <input
                    ...
                    className={`${bgLocations && "bg-opacity-70"} ${
                        subjectLength < subjectLimit
                            ...
                            : "text-red-600"
                    } input max-h-[25px] w-full text-sm bg-base-200 placeholder:dark:text-stone-500 placeholder:text-stone-600 dark:focus:outline-yellow-200 focus:outline-orange-100 focus:shadow-[0_0_5px_2px_rgba(255,255,200,0.9),0_0_15px_8px_rgba(255,193,7,0.6)] dark:focus:shadow-[0_0_10px_5px_rgba(253,224,71,0.5)] lg:placeholder:text-center placeholder:text-left text-center`}
                />
