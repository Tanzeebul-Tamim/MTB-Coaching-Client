...
const Legal = () => {
    ...
    const sectionClassName = (glow) =>
        ...
        } flex-1 bg-base-200 dark:bg-base-100 bg-opacity-60 dark:bg-opacity-60 rounded-xl p-6 shadow-md border border-secondary min-w-[260px] transition-transform duration-500 hover:scale-105 hover:border-primary`;

    const h2ClassName = (glow) =>
        `${
            glow ? "auth-glow scale-110" : ""
        } text-lg md:text-2xl text-amber-800 dark:text-yellow-300 font-bold mb-3 tracking-wide uppercase transition-transform duration-500`;
            ...
            <div className="relative z-20">
                <div className="text-lg text-black dark:text-white flex flex-col lg:gap-8 gap-5 text-center description max-w-[90%] mx-3 md:mx-auto bg-base-200 dark:bg-base-100 bg-opacity-70 dark:bg-opacity-60 md:p-10 p-6 rounded-2xl shadow-2xl border border-secondary">
                    ...
                    <p className="lg:mb-2 mb-1 text-sm md:text-lg leading-relaxed text">
                        ...
                        for this project is available on <i>GitHub</i>. You can
                        view, study, or fork it.
                    </p>

                    <div className="flex flex-col md:flex-row gap-6 w-full justify-center">
                        <section
                            id="privacy-policy"
                            className={sectionClassName(privacyGlow)}
                        >
                            <h2 className={h2ClassName(privacyGlow)}>
                                Privacy Policy
                            </h2>
                        ...
                        <section
                            id="terms"
                            className={sectionClassName(termsOfServiceGlow)}
                        >
                            <h2 className={h2ClassName(termsOfServiceGlow)}>
                                Terms of Service
                            </h2>
                    ...
                    <div className="flex flex-col md:flex-row gap-6 w-full justify-center">
                        <section
                            id="data-deletion"
                            className={sectionClassName(userDataDeletionGlow)}
                        >
                            <h2 className={h2ClassName(userDataDeletionGlow)}>
                                User Data Deletion
                            </h2>
                            <p className="lg:mb-2 mb-1 text-sm md:text-base">
                        ...
                        <section
                            id="cookie"
                            className={sectionClassName(cookieNoticeGlow)}
                        >
                            <h2 className={h2ClassName(cookieNoticeGlow)}>
                                Cookie Notice
                            </h2>
                            <p className="lg:mb-2 mb-1 text-sm md:text-base">
