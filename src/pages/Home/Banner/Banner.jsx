        ...
        >
            <div id="slide1" className="relative w-full">
                <img
                    ...
                    src="../../../../public/home_banner_1.avif"
                />

                <img
                    src="../../../../public/logo.png"
                    className="absolute z-10 lg:w-auto w-1/6 lg:bottom-80 bottom-5 lg:right-10 right-2"
                />
            ...
            <div id="slide2" className="relative w-full">
                <img
                    className="w-full"
                    src="../../../../public/home_banner_2.avif"
                />

                <img
                    src="../../../../public/logo.png"
                    className="absolute z-10 lg:w-auto w-1/6 lg:bottom-72 bottom-5 lg:left-10 left-2"
                />
            ...
            <div id="slide3" className="relative w-full">
                <img
                    className="w-full"
                    src="../../../../public/home_banner_3.avif"
                />

                <img
                    src="../../../../public/logo.png"
                    className="absolute z-10 lg:w-auto w-1/6 lg:bottom-72 bottom-5 lg:right-10 right-2"
                />
